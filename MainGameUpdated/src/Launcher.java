...
public class Launcher {
	...
	public static void main(String[] args) {
		...
		//Titan player = new Titan("Brandon");
		...
		story=reader.nextInt();
		
		if(story==1) {
		advent(1, player, inventory);
		}
		if(story==2) {
		swatStory(1,player,inventory);
		}
		}
	...
	public static void advent(int num, Character player, Item[][] inventory) {
		...
		if (num == 8) {
			...
			System.out.println("Your health has increased by 15");
			player.addHealth(15);
			text_manager(65,
		...
		if (num == 9) {
			...
			if (input == 1) {// if you select one and you didnt lose your wallet
				if (jk.equals("")) {
					...
					text_manager(65, "You remember how that old guy stole your wallet...that means no money...or gambling...RIP");
				}
			}
			if (input == 2) {
	...
	public static void swatStory(int num, Character player, Item[][] inventory) {
		
	
		System.out.println("The smoke clears and the ringing in your ears slowing fades.");
		System.out.println("Bullets wizz past your head.");
	...
	public static void joyalRand(Character player, Enemy enemy, Item[][] inventory) {
		int rand = getRandInt(1, 3);
		Item empty = new Item("Bada Bing Baby");
		int r3 = getRandInt(1, 20);
		if (rand == 1 || rand == 2) {// enemy attacks player
